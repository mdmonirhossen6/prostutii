...
const copy = {
  bn: {
    ...
    chapter: 'অধ্যায়',
    features: [
      'তাৎক্ষণিক সঠিক/ভুল ফিডব্যাক',
      'প্রতিটি প্রশ্নের বিস্তারিত ব্যাখ্যা',
      'বিষয়ভিত্তিক কুইজ সিলেকশন',
      'আসল পরীক্ষার প্রশ্নের আদলে তৈরি',
    ],
  },
  en: {
    ...
    features: [
      ...
      'Designed to mirror real exam patterns',
    ],
  },
};
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)', paddingTop: '8px' }}>
            ...
            <ul style={{
              ...
              {t.features.map((feat, i) => (
                <li key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '14px', color: 'var(--color-text-secondary)' }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00d9a0" strokeWidth="2.5" style={{ flexShrink: 0 }} aria-hidden="true">

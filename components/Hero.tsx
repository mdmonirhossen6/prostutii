...
const copy = {
  bn: {
    ...
    demoLabel: 'নমুনা প্রশ্ন — HSC পদার্থবিজ্ঞান',
  },
  en: {
    ...
    demoLabel: 'Sample Question — HSC Physics',
  },
};
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-5)' }}>
            ...
            <h1
              id="hero-heading"
              style={{
                fontSize: 'clamp(32px, 5vw, var(--font-size-xl))',
                fontWeight: 800,
                lineHeight: 1.1,
          ...
          <div
            ...
            className="hero-card"
            role="complementary"
            aria-label={lang === 'bn' ? 'প্রস্তুতি অ্যাপ প্রিভিউ' : 'Prostuti App Preview'}
          >
            {/* Phone Frame */}
            <div
              style={{
